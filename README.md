...
已确认的产品形态是**桌面优先、个人无需团队服务器、团队共享服务可选，并保留 Web 协作入口**。界面采用 **Workbench W1：暗色优先、青色强调、任务一体化工作台**。W1-01/02 已接入共享控件、主题／密度和新导航壳层；具体页面继续按重建计划推进。当前业务范围仍以上述实现说明为准，桌面安装包和 W1 全量迁移尚未交付。
