...
export const demoMembers: User[] = [
  demoUser,
  { id: 'user-demo-chen', name: '陈一', initial: '陈', color: 'teal' },
  { id: 'user-demo-zhou', name: '周悦', initial: '周', color: 'amber' },
];
export const demoProjects: Project[] = [
  ...
  },
  {
    ...
    spaceId: SPACE_ID,
    name: '团队知识整理',
    description: '让项目资料跟随工作，而不是散落在聊天里。',
    color: 'amber',
    revision: 1,
  },
];
...
function task(
  ...
  return {
    id: `task-${id}`,
    shortId: `HX-${String(id).padStart(3, '0')}`,
    spaceId: SPACE_ID,
    projectId,
    visibility: 'project',
    title,
...
export const demoTasks: Task[] = [
  task(
    ...
    'project-orders',
    demoUser.id,
    '按月份导出订单，沿用当前筛选条件。先完成页面与接口，保持现有权限不变。',
    '待回复 · 导出字段范围',
  ),
  task(
    28,
  ...
  task(19, '订单列表基础布局', 'done'),
  task(21, '订单详情字段整理', 'done', 'project-orders', 'user-demo-chen'),
  task(
    31,
    '整理接口调用示例',
    'in_progress',
